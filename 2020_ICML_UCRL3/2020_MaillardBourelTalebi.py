...
def run_experiment(env_name,learner_names,timeHorizon=10000000,nbReplicates=50):
    ...
    agents= [ [agent, {"nS":nS, "nA":nA, "delta":delta}] for agent in learner_names]
...
envs= ['river-swim-6','grid-4-room','grid-2-room','random-100','random-rich','river-swim-25']
learner_names = [ucrl2, ucrl2b, klucrl, psrl, ucrl3]
